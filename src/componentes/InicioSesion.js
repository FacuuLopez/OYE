...
export class InicioSesion extends Component {
    ...
    return (
        ...
        <div class="input-group">
          <input onChange={this.handleChange} name="mail" type="email" class="form-control" placeholder="Correo Electronico" id="InputEmail1" aria-describedby="emailHelp"/>
        ...
        <div class="mb-3">
          ...
          <div class="input-group">
          <input onChange={this.handleChange} type="password" name="contrasenia" placeholder="Contraseña" class="form-control" id="InputPassword1"/>
